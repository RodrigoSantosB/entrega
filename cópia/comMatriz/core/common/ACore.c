...
bool fontInit()
{
    ...
    //Aqui muda o tamanho
    start = al_load_font("core/Resources/Fonts/pressStart.ttf", 30, 0);
    if (!start)
    {
     ...
     /* ubuntu = al_load_font("core/Resources/Fonts/Ubuntu-R.ttf", 40, 0);
    if (!ubuntu)
    {
...
bool loadGraphics()
{
    menuScreen = al_load_bitmap("core/Resources/Etc/titleScreen2.png");
    if (!menuScreen)
    {
